<div class="static top-0 left-0 h-screen w-64 bg-pink-500 flex flex-col items-center">
	<img src="https://placeimg.com/192/192/people" alt="Profile" class="mt-12 rounded-full w-2/3" />
	...
	<nav class="mt-16">
		<ul class="grid gap-6">
			...
			<a href="/my-garden"><li class="text-white text-2xl">My Garden</li></a>
		</ul>
	</nav>
</div>
